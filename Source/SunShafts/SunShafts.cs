...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class SunShafts : PostEffectsBase
    {
        ...
        private UnityEngine.PostProcessing.MaterialFactory factory = new UnityEngine.PostProcessing.MaterialFactory ();
        ...
        public override bool CheckResources ()
        {
            ...
            sunShaftsMaterial = factory.Get ("SunShaftsComposite.shader");
            simpleClearMaterial = factory.Get ("SimpleClear.shader");
            ...
            foreach (Light light in UnityEngine.Object.FindObjectsOfType<Light> ()) {
                if (light.name == "Directional Light") {
                    ...
                    this.sunTransform.position = new Vector3 (this.sunTransform.position.x,
                        (float)((double)this.height * (double)this.sunTransform.position.y / 2.0),
